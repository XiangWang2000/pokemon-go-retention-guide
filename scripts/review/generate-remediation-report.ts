...
async function main() {
  ...
  await mkdir("review/history", { recursive: true });
  await writeFile("review/history/001-030-remediation.json", json, "utf8");
  await writeFile("review/history/001-030-remediation.md", `${lines.join("\r\n")}\r\n`, "utf8");
  console.log("已產生 review/history/001-030-remediation.md 與 .json。");
}
