...
const links = [
  { href: "/?v=20260718-r4", label: "圖鑑評估", icon: TableProperties },
  { href: "/review?v=20260718-r4", label: "資料待補清單", icon: ClipboardList },
  { href: "/sources?v=20260718-r4", label: "資料來源", icon: Database },
  { href: "/changes?v=20260718-r4", label: "變更紀錄", icon: FileClock },
];
  ...
  return (
    <header className="sticky top-0 z-40 border-b bg-[color-mix(in_srgb,var(--background)_92%,transparent)] backdrop-blur-md">
      <div className="mx-auto flex max-w-[1600px] items-center gap-3 px-4 py-3 lg:px-6">
        <Link href="/?v=20260718-r4" className="flex min-h-11 items-center gap-3 rounded-lg pr-2 font-bold">
