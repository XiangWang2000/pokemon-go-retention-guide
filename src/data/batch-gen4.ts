...
import {
  ...
  directShadowEncounterForms417446,
...
import {
  ...
  directShadowEncounterForms447476,
...
import {
  ...
  directShadowEncounterForms477493,
...
const definitions: Record<string, Gen4BatchDefinition> = {
  "387-416": definition("387-416", {
    ...
    directShadowEncounterForms: directShadowEncounterForms387416,
  ...
  "417-446": definition("417-446", {
    ...
    directShadowEncounterForms: directShadowEncounterForms417446,
  ...
  "447-476": definition("447-476", {
    ...
    directShadowEncounterForms: directShadowEncounterForms447476,
  ...
  "477-493": definition("477-493", {
    ...
    directShadowEncounterForms: directShadowEncounterForms477493,
