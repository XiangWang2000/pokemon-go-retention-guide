...
function makeForm(form: Omit<Gen4BatchForm, "evolutionFamilyNotesZhTw">): Gen4BatchForm {
  ...
  return {
    ...form,
    aliases: [...new Set([...form.aliases, species.nameEn, species.nameZhTw])],
    evolutionFamilyNotesZhTw: note,
  };
}
...
export const releasedNormalForms417493 = new Set<string>([
  "417-sinnoh",
  "418-sinnoh",
  "419-sinnoh",
  "420-sinnoh",
...
export const releasedMegaForms417493 = new Set<string>([
  "428-sinnoh",
  "445-sinnoh",
  "448-sinnoh",
  "460-sinnoh",
...
export const releasedShadowForms417493 = new Set<string>(
  [...shadowReleaseEvidence417493.releasedFormIds].filter((id) =>
    forms417493.some((form) => form.id === id),
  ),
);
...
export function allPvpokeMappings417493() {
  return pvpokeIds417493;
}
...
export const pveEvidence417493: Readonly<Record<string, Gen4PveEvidence>> = {
  "430-sinnoh-shadow": {
    ...
    summaryZhTw: "暗影烏鴉頭頭目前具有高階團體戰輸出，屬核心 PvE 候選。",
  },
  "445-sinnoh-normal": {
    level: "CORE_INVESTMENT",
    roles: ["Current raid tier A+"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "烈咬陸鯊目前仍是高階團體戰攻擊手，屬核心投資。",
  },
  "445-sinnoh-shadow": {
    level: "CORE_INVESTMENT",
    roles: ["Current raid tier S"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "暗影烈咬陸鯊目前屬頂尖團體戰攻擊手，應優先保留與投資。",
  },
  "445-sinnoh-mega": {
    level: "CORE_INVESTMENT",
    roles: ["Mega raid tier S"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers",
    checkedAt: "2026-09-03",
    summaryZhTw: "Mega 烈咬陸鯊具頂尖龍／地面系團體戰輸出，屬核心 Mega 投資。",
  },
  "448-sinnoh-normal": {
    level: "CORE_INVESTMENT",
    roles: ["Current raid tier A"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "路卡利歐目前仍是高階格鬥系團體戰攻擊手，屬核心投資。",
  },
  "448-sinnoh-mega": {
    level: "CORE_INVESTMENT",
    roles: ["Mega raid tier S"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers",
    checkedAt: "2026-09-03",
    summaryZhTw: "Mega 路卡利歐具頂尖格鬥／鋼系團體戰輸出，屬核心 Mega 投資。",
  },
  "460-sinnoh-mega": {
    level: "SPECIAL_USE",
    roles: ["Mega raid tier C overall", "Ice A+"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers",
    checkedAt: "2026-09-03",
    summaryZhTw: "Mega 暴雪王整體團戰定位較窄，但冰系仍有可用屬性用途；只需少量 Mega 候選。",
  },
  "461-sinnoh-shadow": {
    level: "CORE_INVESTMENT",
    roles: ["Current raid tier A+"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "暗影瑪狃拉目前仍是高階團體戰攻擊手，屬核心 PvE 候選。",
  },
  "462-sinnoh-shadow": {
    level: "CORE_INVESTMENT",
    roles: ["Current raid tier A"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "暗影自爆磁怪目前具高階電／鋼系輸出，屬核心 PvE 候選。",
  },
  "464-sinnoh-normal": {
    level: "CORE_INVESTMENT",
    roles: ["Current raid tier A"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "超甲狂犀目前仍是高階岩石／地面系攻擊手，屬核心投資。",
  },
  "464-sinnoh-shadow": {
    level: "CORE_INVESTMENT",
    roles: ["Current raid tier S"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "暗影超甲狂犀目前屬頂尖團體戰攻擊手，應優先保留與投資。",
  },
  "466-sinnoh-normal": {
    ...
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "電擊魔獸目前仍有可用的電系團體戰價值，但不是核心投資。",
  },
  "466-sinnoh-shadow": {
    level: "CORE_INVESTMENT",
    roles: ["Current raid tier A"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "暗影電擊魔獸具高階電系團體戰輸出，屬核心 PvE 候選。",
  },
  "467-sinnoh-shadow": {
    level: "USABLE_OR_BUDGET",
    roles: ["Current raid tier B+"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "暗影鴨嘴炎獸具可用的火系團體戰補位價值；普通版不再承接此用途。",
  },
  "473-sinnoh-normal": {
    level: "CORE_INVESTMENT",
    roles: ["Current raid tier A"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "象牙豬目前仍是高階冰系團體戰攻擊手，屬核心投資。",
  },
  "473-sinnoh-shadow": {
    level: "CORE_INVESTMENT",
    roles: ["Current raid tier S"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "暗影象牙豬目前屬頂尖冰系團體戰攻擊手，應優先保留與投資。",
  },
  "474-sinnoh-shadow": {
    level: "USABLE_OR_BUDGET",
    roles: ["Current raid tier B"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "暗影多邊獸乙型目前只有可用／補位型團體戰價值。",
  },
  "475-sinnoh-shadow": {
    level: "USABLE_OR_BUDGET",
    roles: ["Current raid tier B"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "暗影艾路雷朵目前屬可用的團體戰補位，不列核心投資。",
  },
  "475-sinnoh-mega": {
    level: "CORE_INVESTMENT",
    roles: ["Mega raid tier A+"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers",
    checkedAt: "2026-09-03",
    summaryZhTw: "Mega 艾路雷朵目前具高階超能力／格鬥團體戰價值，屬核心 Mega 投資。",
  },
  "428-sinnoh-mega": {
    level: "SPECIAL_USE",
    roles: ["Mega raid tier C"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers",
    checkedAt: "2026-09-03",
    summaryZhTw: "Mega 長耳兔整體團戰定位較窄；保留實際會使用的 Mega 候選即可。",
  },
  "483-origin-normal": {
    level: "CORE_INVESTMENT",
    roles: ["Current raid tier A"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "起源形態帝牙盧卡目前具高階團體戰輸出，屬核心投資。",
  },
  "483-sinnoh-shadow": {
    level: "CORE_INVESTMENT",
    roles: ["Current raid tier A+"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "暗影帝牙盧卡目前屬高階團體戰攻擊手，應優先保留。",
  },
  "484-origin-normal": {
    level: "CORE_INVESTMENT",
    roles: ["Current raid tier A"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "起源形態帕路奇亞目前具高階團體戰輸出，屬核心投資。",
  },
  "484-sinnoh-shadow": {
    level: "CORE_INVESTMENT",
    roles: ["Current raid tier A+"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "暗影帕路奇亞目前屬高階團體戰攻擊手，應優先保留。",
  },
  "485-sinnoh-normal": {
    level: "USABLE_OR_BUDGET",
    roles: ["Current raid tier B+"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "席多藍恩仍具可用團體戰價值，但普通版不列核心投資。",
  },
  "485-sinnoh-shadow": {
    level: "CORE_INVESTMENT",
    roles: ["Current raid tier A+"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "暗影席多藍恩目前屬高階團體戰攻擊手，屬核心投資。",
  },
  "486-sinnoh-normal": {
    level: "SPECIAL_USE",
    ...
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "雷吉奇卡斯普通版目前只有較窄團體戰用途。",
  },
  "486-sinnoh-shadow": {
    level: "CORE_INVESTMENT",
    roles: ["Current raid tier S"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "暗影雷吉奇卡斯目前屬頂尖團體戰攻擊手，應優先保留。",
  },
  "487-altered-shadow": {
    level: "USABLE_OR_BUDGET",
    roles: ["Current raid tier B+"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "暗影騎拉帝納別種形態目前具可用的團體戰補位價值。",
  },
  "487-origin-normal": {
    level: "USABLE_OR_BUDGET",
    roles: ["Current raid tier B+"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "起源形態騎拉帝納仍有可用的團體戰價值，但不列核心投資。",
  },
  "491-sinnoh-normal": {
    level: "CORE_INVESTMENT",
    roles: ["Current raid tier A"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "達克萊伊目前仍是高階惡系團體戰攻擊手，屬核心投資。",
  },
  "491-sinnoh-shadow": {
    level: "CORE_INVESTMENT",
    roles: ["Current raid tier A+"],
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "暗影達克萊伊目前屬高階團體戰攻擊手，應優先保留。",
  },
  "492-land-normal": {
    level: "SPECIAL_USE",
    roles: ["Current raid tier C"],
  ...
  "492-sky-normal": {
    ...
    sourceUrl: "https://db.pokemongohub.net/best/raid-attackers?includeMegas=false",
    checkedAt: "2026-09-03",
    summaryZhTw: "天空形態謝米仍具可用的草系團體戰價值，但不列核心投資。",
  },
};

export function pveEvidenceForVariant417493(variantId: string) {
  return pveEvidence417493[variantId] ?? null;
}

export const species417446 = species417493.filter(
  (item) => item.dexNumber >= 417 && item.dexNumber <= 446,
);
export const forms417446 = forms417493.filter(
  (item) => item.dexNumber >= 417 && item.dexNumber <= 446,
);
export const evolutionPairs417446 = evolutionPairs417493.filter(([from, to]) => {
  const ids = new Set(forms417446.map((item) => item.id));
  return ids.has(from) || ids.has(to);
});
export const releasedNormalForms417446 = new Set(
  [...releasedNormalForms417493].filter((id) => forms417446.some((form) => form.id === id)),
);
export const directShadowEncounterForms417446 = new Set(
  [...directShadowEncounterForms417493].filter((id) => forms417446.some((form) => form.id === id)),
);
export const releasedShadowForms417446 = new Set(
  [...releasedShadowForms417493].filter((id) => forms417446.some((form) => form.id === id)),
);
export const releasedMegaForms417446 = new Set(
  [...releasedMegaForms417493].filter((id) => forms417446.some((form) => form.id === id)),
);
export const releasedDynamaxForms417446 = new Set(
  [...releasedDynamaxForms417493].filter((id) => forms417446.some((form) => form.id === id)),
);
export const releasedGigantamaxForms417446 = new Set<string>();
export const specialVariants417446 = specialVariants417493.filter((item) =>
  forms417446.some((form) => form.id === item.formId),
);

export const species447476 = species417493.filter(
  (item) => item.dexNumber >= 447 && item.dexNumber <= 476,
);
export const forms447476 = forms417493.filter(
  (item) => item.dexNumber >= 447 && item.dexNumber <= 476,
);
export const evolutionPairs447476 = evolutionPairs417493.filter(([from, to]) => {
  const ids = new Set(forms447476.map((item) => item.id));
  return ids.has(from) || ids.has(to);
});
export const releasedNormalForms447476 = new Set(
  [...releasedNormalForms417493].filter((id) => forms447476.some((form) => form.id === id)),
);
export const directShadowEncounterForms447476 = new Set(
  [...directShadowEncounterForms417493].filter((id) => forms447476.some((form) => form.id === id)),
);
export const releasedShadowForms447476 = new Set(
  [...releasedShadowForms417493].filter((id) => forms447476.some((form) => form.id === id)),
);
export const releasedMegaForms447476 = new Set(
  [...releasedMegaForms417493].filter((id) => forms447476.some((form) => form.id === id)),
);
export const releasedDynamaxForms447476 = new Set(
  [...releasedDynamaxForms417493].filter((id) => forms447476.some((form) => form.id === id)),
);
export const releasedGigantamaxForms447476 = new Set<string>();
export const specialVariants447476 = specialVariants417493.filter((item) =>
  forms447476.some((form) => form.id === item.formId),
);

export const species477493 = species417493.filter(
  (item) => item.dexNumber >= 477 && item.dexNumber <= 493,
);
export const forms477493 = forms417493.filter(
  (item) => item.dexNumber >= 477 && item.dexNumber <= 493,
);
export const evolutionPairs477493 = evolutionPairs417493.filter(([from, to]) => {
  const ids = new Set(forms477493.map((item) => item.id));
  return ids.has(from) || ids.has(to);
});
export const releasedNormalForms477493 = new Set(
  [...releasedNormalForms417493].filter((id) => forms477493.some((form) => form.id === id)),
);
export const directShadowEncounterForms477493 = new Set(
  [...directShadowEncounterForms417493].filter((id) => forms477493.some((form) => form.id === id)),
);
export const releasedShadowForms477493 = new Set(
  [...releasedShadowForms417493].filter((id) => forms477493.some((form) => form.id === id)),
);
export const releasedMegaForms477493 = new Set(
  [...releasedMegaForms417493].filter((id) => forms477493.some((form) => form.id === id)),
);
export const releasedDynamaxForms477493 = new Set(
  [...releasedDynamaxForms417493].filter((id) => forms477493.some((form) => form.id === id)),
);
export const releasedGigantamaxForms477493 = new Set<string>();
export const specialVariants477493 = specialVariants417493.filter((item) =>
  forms477493.some((form) => form.id === item.formId),
);
