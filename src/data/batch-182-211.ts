...
export interface Gen2Species182211 {
  dexNumber: number;
  nameEn: string;
  nameZhTw: string;
  types: string[];
...
export interface SpecialVariant182211 {
  id: string;
  formId: string;
  variantKey: "MEGA";
  released: boolean;
...
export const forms182211: Form182211[] = [
  ...
  },
  {
    ...
    evolutionFamilyNotesZhTw:
      "第 2 世代標準城都型態；普通、暗影、淨化與 Max 版本分開評估，後續世代進化以正式 stub 保留。",
    isStub: false,
    includeVariants: true,
  },
  {
  ...
  },
  {
    ...
    aliases: ["Galarian Slowking", "伽勒爾呆呆王"],
    evolvesFromFormId: "079-galar",
    evolutionFamilyNotesZhTw:
      "伽勒爾呆呆王是既有伽勒爾呆呆獸分支的已推出型態；不與標準城都呆呆王共用型態或用途結論。",
    isStub: false,
    includeVariants: true,
  },
];
export const evolutionPairs182211: readonly [string, string][] = [
  ...
  ["203-johto", "981-paldea"],
  ["206-johto", "982-paldea"],
  ["207-johto", "472-sinnoh"],
];
export const releasedShadowForms182211 = new Set<string>([
  "182-johto",
  "185-johto",
  "186-johto",
  "187-johto",
...
export const migratedStubIds182211 = new Set<string>([
  "182-kanto",
  "186-kanto",
  "196-kanto",
  "197-kanto",
