...
export type Gen6PlanDisposition = "CLEAR_USE" | "LIMITED_USE" | "NO_SIGNIFICANT_USE" | "NOT_APPLICABLE_OR_UNRELEASED" | "TRUE_DATA_PENDING";
...
function disposition(decision: Gen6PlanDecision, status: CandidateReleaseStatus): Gen6PlanDisposition {
  if (status === "UNKNOWN") return "TRUE_DATA_PENDING";
