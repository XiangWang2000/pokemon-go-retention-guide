...
export interface SpecialVariant242251 {
  id: string;
  formId: string;
  variantKey: "MEGA";
  released: boolean;
...
export const forms242251: Form242251[] = [
  {
    ...
    evolutionFamilyNotesZhTw:
      "幸福蛋由既有吉利蛋家族進化；正式城都成員不因跨世代圖鑑號拆成新家族。",
    isStub: false,
  ...
  },
  {
    ...
    evolutionFamilyNotesZhTw:
      "第 2 世代標準城都型態；已依來源核對 Shadow／Max 發布狀態，不把未列出的 Mega 當成已推出。",
    isStub: false,
    includeVariants: true,
  },
  {
  ...
  },
  {
    ...
    regionKey: "JOHTO",
    types: ["ROCK", "GROUND"],
    aliases: ["larvitar", "幼基拉斯"],
    evolvesFromFormId: null,
    evolutionFamilyNotesZhTw:
      "幼基拉斯、沙基拉斯與班基拉斯為同一進化家族；前階保留僅為後續進化或個體培育需求。",
    isStub: false,
    includeVariants: true,
  },
  {
  ...
  },
  {
    ...
    regionKey: "JOHTO",
    types: ["ROCK", "DARK"],
    aliases: ["tyranitar", "班基拉斯"],
    evolvesFromFormId: "247-johto",
    evolutionFamilyNotesZhTw:
      "班基拉斯的普通、暗影、Mega 與 Max 用途分開評估；重點來源不代表全家族都必留。",
    isStub: false,
    includeVariants: true,
  },
  {
    ...
    evolvesFromFormId: null,
    evolutionFamilyNotesZhTw:
      "洛奇亞的 PvP、PvE 與 Max 用途分開評估；沒有將未實裝的型態視為已發布。",
    isStub: false,
    includeVariants: true,
  },
  {
  ...
  },
  {
    ...
    evolvesFromFormId: null,
    evolutionFamilyNotesZhTw:
      "時拉比以 PvP、活動招式與特殊收集價值分開評估；不因傳奇身分自動設為必留。",
    isStub: false,
    includeVariants: true,
  },
];
...
export const releasedMegaForms242251 = new Set<string>(["248-johto"]);
