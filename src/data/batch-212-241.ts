...
export interface Gen2Species212241 {
  dexNumber: number;
  nameEn: string;
  nameZhTw: string;
  types: string[];
...
export interface SpecialVariant212241 {
  id: string;
  formId: string;
  variantKey: "MEGA";
  released: boolean;
...
export const forms212241: Form212241[] = [
  {
    ...
    evolutionFamilyNotesZhTw:
      "本批已將進化關係結構化；跨世代後續進化以正式 stub 保留，Mega／Max／暗影版本分開評估。",
    isStub: false,
...
export const migratedStubIds212241 = new Set<string>(["212-kanto", "230-kanto", "233-kanto"]);
