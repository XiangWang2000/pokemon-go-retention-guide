...
import { readExpectedPagesSmokeContract } from "../scripts/pages/pages-http-smoke.mjs";
...
describe("Pages HTTP smoke contract", () => {
  it("samples the first, middle, and last current detail routes", async () => {
    ...
    const expected = indexes.map((index) => `pokemon/${encodeURIComponent(rows[index].id)}/`);
